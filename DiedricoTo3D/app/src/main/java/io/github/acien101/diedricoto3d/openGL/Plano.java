...
public class Plano {
    ...
    public Plano(float desplazamientoPlanoOrigen, float cota, float alejamiento, float desplazamiento) {
        float[] plano = {0.0f,0.0f, desplazamientoPlanoOrigen,
                0.0f, cota, desplazamiento,
                alejamiento, 0.0f, desplazamiento};
