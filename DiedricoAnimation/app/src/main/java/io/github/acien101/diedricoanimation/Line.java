...
public class Line {
    ...
    public Line(LineVector lineVector, float[] color){
        float[] lineCoords = {lineVector.getLineXA(), lineVector.getLineYA(), lineVector.getLineZA(), lineVector.getLineXB(), lineVector.getLineYB(), lineVector.getLineZB()};
