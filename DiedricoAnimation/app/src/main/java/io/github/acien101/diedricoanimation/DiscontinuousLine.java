...
import io.github.acien101.diedricoanimation.vector.Vector;
...
public class DiscontinuousLine {
    ...
    public DiscontinuousLine(PointVector pointA, PointVector pointB, float[] color){
        ...
        List<PointVector> firstRowPoints = new ArrayList<>();
        firstRowPoints.add(pointA);
        firstRowPoints.add(pointB);

        List<PointVector> secondRowPoints = new ArrayList<>();
        secondRowPoints.add()
